...
n.comps <- c(4,14,24,34,44,54,64,74,84,94,104)
...
#    load(paste("result", n.comps[i], "comps.f2s_logtime.RData", sep=""))
#    BIC[i] <- result[[1]]$BIC
...
#load("result6comps.RData")
#plotResults(result[[1]], data=full.data, "results_20clust.F2S")